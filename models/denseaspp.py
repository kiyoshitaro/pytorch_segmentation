"""
[1] https://github.com/wutianyiRosun/CGNet/blob/master/model/DenseASPP.py
    ...
    * output_scale can only set as 8 or 16
    ...
    def __init__(self, n_class=19, output_stride=8):
        ...
        self.classification = nn.Sequential(
            ...
            nn.Conv2d(
                in_channels=num_features, out_channels=n_class, kernel_size=1, padding=0
            ),
...
class _DenseAsppBlock(nn.Sequential):
    ...
    def __init__(self, input_num, num1, num2, dilation_rate, drop_out, bn_start=True):
        ...
        self.add_module(
            "conv1", nn.Conv2d(in_channels=input_num, out_channels=num1, kernel_size=1)
        ),
...
class _DenseLayer(nn.Sequential):
    def __init__(
        self, num_input_features, growth_rate, bn_size, drop_rate, dilation_rate=1
    ):
