"""
[1] https://github.com/yiskw713/DualAttention_for_Segmentation/blob/master/model/drn.py
[2] https://arxiv.org/pdf/1705.09914.pdf
@misc{yu2017dilated,
...
def drn_c_42(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls["drn-c-42"]), strict=False)
    return model
...
def drn_c_58(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls["drn-c-58"]), strict=False)
    return model
...
def drn_d_22(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls["drn-d-22"]), strict=False)
    return model
...
def drn_d_24(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls["drn-d-24"]), strict=False)
    return model
...
def drn_d_40(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls["drn-d-40"]), strict=False)
    return model
...
def drn_d_54(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls["drn-d-54"]), strict=False)
    return model
...
def drn_d_56(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls["drn-d-56"]), strict=False)
    return model
...
def drn_d_107(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(model_zoo.load_url(model_urls["drn-d-107"]), strict=False)
    return model
