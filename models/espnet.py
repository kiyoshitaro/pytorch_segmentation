"""
[1] https://github.com/wutianyiRosun/CGNet/blob/master/model/ESPNet.py
[2] https://arxiv.org/pdf/1803.06815.pdf

@misc{mehta2018espnet,
...
class ESPNet(nn.Module):
    ...
    def __init__(self, classes=19, p=2, q=3, encoderFile=None):
        ...
        self.up_l3 = nn.Sequential(
            nn.ConvTranspose2d(
                classes, classes, 2, stride=2, padding=0, output_padding=0, bias=False
            )
        )
