...
"""
[1] https://github.com/wutianyiRosun/CGNet/blob/master/model/DFN.py
[2] https://openaccess.thecvf.com/content_cvpr_2018/papers/Yu_Learning_a_Discriminative_CVPR_2018_paper.pdf
"""
...
class DFN(nn.Module):
    def __init__(self, num_class=19):
        ...
        self.layer1 = nn.Sequential(
            self.resnet_features.maxpool, self.resnet_features.layer1
        )
