...
[2] Li, X., Zhang, L., You, A., Yang, M., Yang, K., & Tong, Y. (2019). 
    Global aggregation then local distribution in fully convolutional networks. ArXiv.
[3] https://github.com/lxtGH/GALD-DGCNet/blob/master/libs/models/GALDNet.py
'''
